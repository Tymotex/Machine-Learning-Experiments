...
def MNIST_Train(save_model=False):
    ...
    # np.argmax is for selecting the output with greatest probability in the distribution
    print(np.argmax(predictions[0]))
    
    # Saves the model and its weights, training configuration, etc. to the hard drive.
    # Models can be loaded elsewhere and used for making predictions!
    if save_model:
